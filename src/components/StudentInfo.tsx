...
import {ArrowBack, Edit, Save, Check} from 'material-ui-icons';
...
const _labels = {
  ...
  [patronymic]: {label: 'Surname', mapping: 'patronymic'},
...
class StudentInfo extends React.Component<any, any> {
  ...
  onEditClick = () => {this.setState({mode: StudentInfoModes.EDIT}); };
  ...
  onSaveClick = () => {
    ...
    if (!this.state.loading) {
      ...
      console.log(data);
      axios.post('http://localhost:8080/student/update', data)
  ...
  render() {
    ...
    return (
      <Grid container spacing={24}>
        ...
        <Grid item xs={2}>
          {((_mode) => {
            if (_mode === StudentInfoModes.EDIT) {
